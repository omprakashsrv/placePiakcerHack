...
public class PlacePickerFragment extends Fragment implements OnCardClickListener {
    ...
    public void onCardClick(int cardActionId, String cardTag) {
        if (cardActionId == ACTION_PICK_PLACE) {
             ...
             */
            showPlacePicker(REQUEST_PLACE_PICKER, PlacePickerActivity.MAP_PLACE_PICKER);
//            try {
...
//            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (data == null || data.getIntExtra(PlacePickerActivity.PLACE_PICKER_TYPE, -1) == -1) {
            showPlacePicker(REQUEST_PLACE_PICKER, PlacePickerActivity.AUTO_COMPLETE_PLACE_PICKER);
    ...
    public void showPlacePicker(int requestCode, int placePickerType) {
        Intent placePickerActivity = new Intent(getActivity().getApplicationContext(), PlacePickerActivity.class);
        placePickerActivity.putExtra(PlacePickerActivity.PLACE_PICKER_TYPE, placePickerType);
        startActivityForResult(placePickerActivity, requestCode);
    }
